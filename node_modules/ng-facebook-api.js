...
module.service('FacebookService', function FacebookService($q) {
	...
	var getLikes = function (id, fields) {
		var deferred = $q.defer();

		var userId = angular.isUndefined(id) ? "me" : id;
		api('/' + userId + '/likes', API_METHOD.GET).then( function(response){
			deferred.resolve({ likes: response.data, authResponse: currentUserAuthResponse });
		}, function (err) {
			deferred.reject(err);
		});
	...
	var getClick = function (path, method, params) {
		var deferred = $q.defer();
		window.fbAsyncInit = function () {
