coupon
    .controller('CouponCtrl', function ($scope, $location, $rootScope, $window, $timeout, DataApi, Thesocket) {
        ...
        // accept coupon api
        $scope.a_coupon = function () {
            DataApi.acceptCoupon($scope.detail.the_issuer[0].id).then(function (response) {
                if (response.data.error_code === 0) {
